...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        dp.setNombres("Oscar Mateo");
        dp.setApellidos("Lainez Carranza");
        dp.setTelefono("504 34213522");
        dp.setEdad(40);
        dp.setDisciplina("Futbol");
        dp.setPosicion("Delantero");
        
        
        System.out.println(dp.getNombres());
        System.out.println(dp.getApellidos());
        System.out.println(dp.getTelefono());
        System.out.println(dp.getEdad());
        System.out.println(dp.getDisciplina());
        System.out.println(dp.getPosicion());
